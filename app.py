...
try:
    rag_engine = RAGEngine(
        ...
        ollama_model=OLLAMA_MODEL,  # Pass model name as parameter
        chroma_persist_dir=CHROMA_PERSIST_DIR,
        document_dir=DOCUMENT_DIR  # Pass document dir as parameter
    )
...
def ingest_data():
    ...
    try:
        ...
        try:
            ...
            return jsonify({
                "status": "error", 
                "message": f"Cannot connect to Ollama: {str(e)}. Please ensure Ollama is running."
            }), 500
...
def chat():
    ...
    try:
        ...
        if message.lower() == 'exit':
            return "Thank you for reaching out. Feel free to visit us again. Bye!"
        ...
        try:
            ...
            return f"Sorry, I encountered an error while processing your message. Please try again later."
    except Exception as e:
